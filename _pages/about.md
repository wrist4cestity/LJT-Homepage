...
1. **SynLogic: Synthesizing Verifiable Reasoning Data at Scale for Learning Logical Reasoning and Beyond**  
   ...
   *arXiv*, 2025. Code: [MiniMax-AI/SynLogic](https://github.com/MiniMax-AI/SynLogic)
...
2. **On the Perception Bottleneck of VLMs for Chart Understanding**  
   ...
   *arXiv*, 2025. Code: [hkust-nlp/Vision4Chart](https://github.com/hkust-nlp/Vision4Chart)

**2024**

3. **On the Universal Truthfulness Hyperplane Inside LLMs**  
   **Junteng Liu**, Shiqi Chen, Yu Cheng, Junxian He  
   *EMNLP 2024*. Code: [hkust-nlp/Universal_Truthfulness_Hyperplane](https://github.com/hkust-nlp/Universal_Truthfulness_Hyperplane)
